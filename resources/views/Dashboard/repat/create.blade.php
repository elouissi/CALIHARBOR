...
@endif
<form action="{{ route('repat.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div id="show_item">
            <div class="row">
                ...
                <div class="col-md-2 mb-3 d-grid">
                    ...
                    <button style="height: 47px; margin-top: 34px;"  class="btn btn-sm btn-primary add_item_btn"><i class="fa fa-plus"></i></button>
                </div>
            </div>
        </div>

    
        <button type="submit"class="btn btn-sm btn-primary">add repat</button>
